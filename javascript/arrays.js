...
//the fucntion handler 
function onImageClick (evt)
{
  var onlyPath = evt.target.getAttribute("src");
  //console.log (onlyPath);
  
  //the index of array method searches for a match in the array and if it finds the data, it sends back (or returns) the index position in the array
  ...
  function update_shopping_cart()
  {
    ...
    //make a shortcut to the div id-"shoppping_cart_div"
    ...
    //use a -1 after imagelist.;ength so the condition is always one less (to match the index number)
    {
